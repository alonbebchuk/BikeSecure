...
namespace SDSApplication.Services
{
    public class BluetoothLEService
    {
        ...
        public async Task<List<DeviceCandidate>> ScanForDevicesAsync()
        {
            ...
            try
            {
                IReadOnlyList<IDevice> systemDevices = Adapter.GetSystemConnectedOrPairedDevices(UartGattUuids.UartGattServiceUuids);
                ...
                await Adapter.StartScanningForDevicesAsync(UartGattUuids.UartGattServiceUuids);
            }
            catch (Exception ex)
            {
